...
('Ahmed Malik', 'ahmed.malik@gmail.com', '$2a$10$pyS7uoW6t4r/o/C0ubqJoOwe9sqAHpFVWGyRdJFpIU2odfTNaTdly', 'Action', 'Movie lover from Lahore.', 'images/avatars/male-avatar.svg'),
('Laura Smith', 'laura.smith@gmail.com', '$2a$10$fjGbW3aJWUZhohHWaomoYu44Pmou0Mo0BDJIjaNXisdi64y0sCIAW', 'Romance', 'Netflix binge watcher.', 'images/avatars/female-avatar.svg'),
('Javier Torres', 'javier.torres@cine.es', '$2a$10$dlBIMnoqOl0iqMf0Gzj.CukCEUbSzbbs4zmCV3iixPWw4qL3DWmaS', 'Drama', 'Spanish film critic.', 'images/avatars/male-avatar.svg'),
('Zahra Hosseini', 'zahra.hoss@iran.ir', '$2a$10$pyS7uoW6t4r/o/C0ubqJoOwe9sqAHpFVWGyRdJFpIU2odfTNaTdly', 'Thriller', 'Iranian cinema enthusiast.', 'images/avatars/female-avatar.svg'),
('Emily Brown', 'emily.brown@yahoo.com', '$2a$10$MJX4C7nbOiHLeNlA/u6go.VOM80xki8/9tlnzsbmrBtkDAEH7a7JO', 'Comedy', 'Loves light-hearted films.', 'images/avatars/female-avatar.svg'),
('Bilal Ahmed', 'bilal.ahmed@pakmail.com', '$2a$10$.5GYHxznXAp8sYWZEcJttOM6T1LMfcYWulfawMG5k64sjV9vbGWae', 'Horror', 'Horror genre expert.', 'images/avatars/male-avatar.svg'),
('Omar Farooq', 'omar.farooq@gmail.com', '$2a$10$3zA04UpEf6k826cYmZG8o.W66ViEXnrfH2dDeDptvV2EDUK275/62', 'Sci-Fi', 'Fascinated by futuristic films.', 'images/avatars/male-avatar.svg'),
('Isabella Cruz', 'isabella.cruz@cine.es', '$2a$10$qO2Lzxbs.a6T1PfqBFmjoeZFxgT5ldSGC.WUsfCxTanvs9gpK0nB.', 'Romance', 'Love is the theme of every movie.', 'images/avatars/female-avatar.svg'),
('Hassan Raza', 'hassan.raza@yahoo.com', '$2a$10$hulqNPqOPYN3IOyi4rxpsuvYo5mnt1xlxyQfr7QUwIfK3m0GJK2s6', 'Action', 'Adrenaline junkie.', 'images/avatars/male-avatar.svg'),
('Natalie Green', 'natalie.green@gmail.com', '$2a$10$o8SfrF2e.y/UvAK.2gLzxe15zIJQWrlq8WG16sr0BjULqin3inPBa', 'Drama', 'Love film discussions.', 'images/avatars/female-avatar.svg'),
('Fatima Noor', 'fatima.noor@pakmail.com', '$2a$10$63K9STQSkao6T25rcYqS.ukGWEteVhv6EyoBuAYpYEhSkD8Kz2Lg.', 'Comedy', 'Pakistani film fan.', 'images/avatars/female-avatar.svg'),
('Pedro Sanchez', 'pedro.san@cine.es', '$2a$10$a12fWQDZzgRejquZKQnXeutbGovugk7PaGfMdueI87csHIgxefEn.', 'Thriller', 'Spanish indie director.', 'images/avatars/male-avatar.svg'),
('Mina Tavakoli', 'mina.tav@iran.ir', '$2a$10$k/jfvZGGfAtXa0IX2Ndlb.lzA4m/ycjTF3J4tq/dsizHQLNBjsNni', 'Drama', 'Appreciates artistic cinema.', 'images/avatars/female-avatar.svg'),
('Robert Miller', 'robert.miller@gmail.com', '$2a$10$Y3/qBFOamG10Utge./hHIuXuXEWECmbTttqQxNW1Euy88hkKyfvva', 'Adventure', 'Travel and movie buff.', 'images/avatars/male-avatar.svg'),
...
('Pan''s Labyrinth', 'A dark fantasy in post-Civil War Spain.', 2006, 'images/posters/pans_labyrinth.webp', 118, 'Spanish', 'Guillermo del Toro', 'jVZRnnVSQ8k', 3, 8.7),
